...
linear = LinearRegression(n_features=X_train.shape[1], n_steps=1000, learning_rate=0.05, lmd=0.01)

cost_history, theta_history = linear.fit_fullbatch_regularization(X_train, y_train)
